...
<head>
    ...
    <script type="text/javascript">
        var defaultModule = angular.module('defaultModule', ['ui.bootstrap']);

        defaultModule.controller("SignUp", ['$scope', SignUp]);
...
<body>
    ...
    <div class="site-wrapper-reveal">
        ...
        <div class="news-staps">
            <!--========= News Area ===========-->
            <div class="pricing-table-area section-space--pb_20 position-relative " ng-controller="SignUp">
                <div class="pricing-table-content-area">
                    <div class="container">
                        <div class="row pricing-table-two">
                            <div class="col-12">
                                <form method="post" action="./Signup.aspx" onsubmit="javascript:return WebForm_OnSubmit();" id="frm">
                                    <div class="aspNetHidden">
                                        <input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
                                        <input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
                                        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTE2ODUzNjk5MTgPZBYCZg9kFgICIg9kFgICAQ9kFgICBw9kFgICGQ8PFgIeE1ZhbGlkYXRlUmVxdWVzdE1vZGUCAmRkZH1noYChiq6SuCPFRHN1UV9xgrij" />
                                    </div>
                                    ...
                                    <script src="/WebResource.axd?d=6JF8kMNIkrkDPhG_WaN3U3yM855XUuB8sgEKP8GbZiEL8wEXogN6nZh0nhxAu7nDoTpgyrYWErZZNqJz6PU4r5pjhlM1&amp;t=637322061357241717" type="text/javascript"></script>


                                    <script src="/WebResource.axd?d=LEjrb7Nw3k_51RruU0rYa1iVMUm-hGN-kPI1TrU6ngXPSz0SvU0v6U-LdIBR3gRRKIYfUH_6wYVLYl9SZyKNPWENG1HAaHtNw_RD0YDVv8zLCZwv0&amp;t=637322061357241717" type="text/javascript"></script>
                                    <script type="text/javascript">
                                        //<![CDATA[
                                    ...
                                    <div class="aspNetHidden">
                                        ...
                                        <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAAaU1VW2LpcxfH2ejwxjSd9LkKgxRiUL2hA39rl/A3ChBrDC03mjn2juzVI+TWgBXpD3ZyjsUw+Euz9PvbvhftEpj97fm6VKcnFk/8dU8m/tvg6pfQ6tdmpuIL5jKnfUdjX1OAFL4f9iKryZcAAgXShI2zD4kg==" />
                                    </div>
                                    <div style=" padding: 100px; background: #99999926;">
                                        ...
                                        <p class="section-text wow move-up animated" style="visibility: visible;">
                                            مرحباً بكم تسجيل حساب جديد
                                        </p>

                                        <div id="CphBody_PnlPersonalInfo">

                                            <div style="margin: 20px;">
                                                <label style="width: 20%">
                                                الرقم الشخصي القطري</label>
                                                <input name="ctl00$CphBody$txtQID" type="text" maxlength="11" id="CphBody_txtQID" style="width: 50%; border-radius: 10px; border: none; background: #dcdcdc; height: 50px; margin: 20px 20px 0 20px; padding: 20px; color: #333;" />
                                                <span id="CphBody_QIDRequired" title="User Name is required." class="failureNotification" style="visibility:hidden;">الرقم الشخصي مطلوب ‎</span>
                                            </div>
                                            <div style="margin: 20px;">
                                                <label style="width: 20%">
                                                تاريخ انتهاء صلاحية البطاقة الشخصية ‎</label>
                                                <div class="input-group" id="calanderGroup" style="display: inline;">
                                                    <input name="ctl00$CphBody$txtQidExp" type="text" id="txtQidExp" datepicker-popup="{{&#39;yyyy-MM-dd&#39;}}" ng-model="BirthDate" is-open="DatePickerIsOpen" datepicker-options="dateOptions" ng-required="true" close-text="Close" placeholder="YYYY-MM-DD"
                                                        style="width: 50%; border-radius: 10px; border: none; background: #dcdcdc; height: 50px; margin: 20px 20px 0 -95px; padding: 20px; color: #333;" />
                                                    <div class="input-group-append" style="display: inherit; margin: 20px 0 0 0;">
                                                        <button class="btn btn-outline-secondary" type="button" ng-click="OpenDatePicker($event)"><i class="fa fa-calendar" aria-hidden="true"></i></button>
                                                    </div>
                                                </div>
                                                <span id="CphBody_txtQidExpValidator" title="QID expiry is required." class="failureNotification" style="visibility:hidden;">البريد الالكتروني مطلوب‎</span>
                                            </div>
                                            <div style="margin: 20px;">
                                                <label style="width: 20%">
                                                البريد الإلكتروني
                                            </label>
                                                <input name="ctl00$CphBody$txtEmail" type="email" id="CphBody_txtEmail" style="width: 50%; border-radius: 10px; border: none; background: #dcdcdc; height: 50px; margin: 20px 20px 0 20px; padding: 20px; color: #333;" />
                                                <span id="CphBody_txtEmailValidator" title="Email is required." class="failureNotification" style="visibility:hidden;">رقم التليفون مطلوب ‎</span>
                                            </div>
                                            <div style="margin: 20px;">
                                                <label style="width: 20%">
                                                رقم الهاتف الجوال
                                            </label>
                                                <input name="ctl00$CphBody$txtMobile" type="number" maxlength="8" id="CphBody_txtMobile" style="width: 50%; border-radius: 10px; border: none; background: #dcdcdc; height: 50px; margin: 20px 20px 0 20px; padding: 20px; color: #333;" />
                                                <span id="CphBody_txtMobileValidator" title="Mobile number is required." class="failureNotification" style="visibility:hidden;">رقم الهاتف مطلوب‎</span>
                                            </div>
                                            <div style="text-align: center;">
                                                <!-- commented the below line -->
                                                <!-- <input type="submit" name="ctl00$CphBody$btnSendOtp" value="التالى" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$CphBody$btnSendOtp&quot;, &quot;&quot;, true, &quot;1stStep&quot;, &quot;&quot;, false, false))" -->
                                                id="btnSendOtp" class="ht-btn ht-btn-default" />
                                                <div id="divLoader" style="display: none" class="spinner-border" role="status">
                                        ...
                                        <div style="text-align: center;">
                                            <a href="login.aspx" style="margin-top: 20px">
                                            لديك حساب حالي برجاء الضغط هنا</a>
                                        </div>
                                    </div>

                                    <script type="text/javascript">
                                        //<![CDATA[
                                        var Page_Validators = new Array(document.getElementById("CphBody_QIDRequired"), document.getElementById("CphBody_txtQidExpValidator"), document.getElementById("CphBody_txtEmailValidator"), document.getElementById("CphBody_txtMobileValidator"));
                                        //]]>
                                    </script>

                                    <script type="text/javascript">
                                        //<![CDATA[
                                        var CphBody_QIDRequired = document.all ? document.all["CphBody_QIDRequired"] : document.getElementById("CphBody_QIDRequired");
                                        CphBody_QIDRequired.controltovalidate = "CphBody_txtQID";
                                        CphBody_QIDRequired.validationGroup = "1stStep";
                                        CphBody_QIDRequired.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
                                        CphBody_QIDRequired.initialvalue = "";
                                        var CphBody_txtQidExpValidator = document.all ? document.all["CphBody_txtQidExpValidator"] : document.getElementById("CphBody_txtQidExpValidator");
                                        CphBody_txtQidExpValidator.controltovalidate = "txtQidExp";
                                        CphBody_txtQidExpValidator.validationGroup = "1stStep";
                                        CphBody_txtQidExpValidator.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
                                        CphBody_txtQidExpValidator.initialvalue = "";
                                        var CphBody_txtEmailValidator = document.all ? document.all["CphBody_txtEmailValidator"] : document.getElementById("CphBody_txtEmailValidator");
                                        CphBody_txtEmailValidator.controltovalidate = "CphBody_txtEmail";
                                        CphBody_txtEmailValidator.validationGroup = "1stStep";
                                        CphBody_txtEmailValidator.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
                                        CphBody_txtEmailValidator.initialvalue = "";
                                        var CphBody_txtMobileValidator = document.all ? document.all["CphBody_txtMobileValidator"] : document.getElementById("CphBody_txtMobileValidator");
                                        CphBody_txtMobileValidator.controltovalidate = "CphBody_txtMobile";
                                        CphBody_txtMobileValidator.validationGroup = "1stStep";
                                        CphBody_txtMobileValidator.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
                                        CphBody_txtMobileValidator.initialvalue = "";
                                        //]]>
                                    </script>
...
<script id="f5_cspm">
    (function() {
        var f5_cspm = {
            f5_p: 'MJEINEGCBPLFLLACJCHOPDFJDKONPNEEGCBMOKCJKIMNMJBHHDDGIALEKDLAGAKABFBAJIDJJODBFMCGBAPBEEKLAELAALLGAAGBJIKECIGKBHEEAAMLAFPLNELJIMCB',
